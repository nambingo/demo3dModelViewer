package com.example.framgiaphamducnam.demo3dmodelview.services.wavefront;
								 ...
								 final String assetsDir, final String modelId, final Object3DBuilder.Callback callback)
	{
		new LoaderTask(parent,url,currentDir,assetsDir,modelId,callback){
			...
			protected List<Object3DData> build() throws IOException {
				...
				com.example.framgiaphamducnam.demo3dmodelview.services.WavefrontLoader wfl = new
						com.example.framgiaphamducnam.demo3dmodelview.services.WavefrontLoader
						("");
