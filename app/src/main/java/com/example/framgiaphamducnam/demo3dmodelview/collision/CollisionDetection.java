package com.example.framgiaphamducnam.demo3dmodelview.collision;
...
public class CollisionDetection {
    ...
    public static Object3DData getBoxIntersection(List<Object3DData> objects, float[] p1, float[] direction) {
        ...
        for (Object3DData obj : objects) {
            ...
            com.example.framgiaphamducnam.demo3dmodelview.entities.BoundingBox box = obj.getBoundingBox();
            //float[] intersection = getBoxIntersection(p1, direction, box);
            float[] intersection = {0.1f, 0.1f};
     ...
     */
    public static boolean isBoxIntersection(float[] origin, float[] dir, com.example.framgiaphamducnam.demo3dmodelview.entities.BoundingBox b) {
     ...
     */
    public static float[] getBoxIntersection(float[] origin, float[] dir, com.example.framgiaphamducnam.demo3dmodelview.entities.BoundingBox b) {
    ...
    public static float[] getTriangleIntersection(List<Object3DData> objects, ModelRenderer mRenderer, float windowX, float windowY) {
        ...
        if (intersected != null) {
            Log.d("CollisionDetection", "--intersected:" + intersected.getId() + ", rayOrigin:" +
                    Arrays
