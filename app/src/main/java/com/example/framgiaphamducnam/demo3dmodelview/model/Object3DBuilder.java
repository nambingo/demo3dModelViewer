package com.example.framgiaphamducnam.demo3dmodelview.model;

import android.app.Activity;
import android.content.res.AssetManager;
import android.opengl.GLES20;
import android.util.Log;
import com.example.framgiaphamducnam.demo3dmodelview.services.WavefrontLoader;
import com.example.framgiaphamducnam.demo3dmodelview.services.collada.loader.ColladaLoader;
import com.example.framgiaphamducnam.demo3dmodelview.services.stl.STLLoader;
import com.example.framgiaphamducnam.demo3dmodelview.services.wavefront.WavefrontLoader2;
import com.example.framgiaphamducnam.util.math.Math3DUtils;
...
public final class Object3DBuilder {
	...
	final static float[] squarePositionData = new float[]{
			// @formatter:off
			-0.3f, 0.0001f, 0.5f, // top left front
			-0.5f, -0.3f, 0.5f, // bottom left front
			0.5f, -0.3f, 0.5f, // bottom right front
			0.3f, 0.0001f, 0.5f, // upper right front
			-0.5f, 0.1f, -0.5f, // top left back
			-0.5f, -0.5f, -0.5f, // bottom left back
			0.5f, -0.5f, -0.5f, // bottom right back
			0.5f, 0.1f, -0.5f // upper right back
			// @formatter:on
	};
	...
	final static float[] squarePositionDataLeft = new float[]{
			// @formatter:off
			-0.3f, 0.0001f, 0.5f, // top left front
			-0.5f, -0.3f, 0.5f, // bottom left front
			0.5f, -0.3f, 0.5f, // bottom right front
			0.3f, 0.0001f, 0.5f, // upper right front
			-0.5f, 0.1f, -0.5f, // top left back
			-0.5f, -0.1f, -0.5f, // bottom left back
			0.5f, -0.1f, -0.5f, // bottom right back
			0.5f, 0.1f, -0.5f // upper right back
			// @formatter:on
	};
	final static float[] squarePositionDataLeft2 = new float[]{
			// @formatter:off
	...
	final static int[] squareDrawOrderDataLeft = new int[]{
			// @formatter:off
			// front
			0, 1, 2,
			0, 2, 3,
	...
	final static float[] cubePositionData2 = {
			//@formatter:off
			// Front face
			-1.0f, 1.0f, 1.0f,
			-1.0f, -1.0f, 1.0f,
	...
	public static Object3DData buildPoint(float[] point) {
		return new Object3DData(createNativeByteBuffer(point.length * 10).asFloatBuffer().put
				(point))
	...
	public static Object3DData buildCubeV1() {
		return new Object3DData(
				createNativeByteBuffer(cubePositionData.length * 4).asFloatBuffer().put
						(cubePositionData))
				.setDrawMode(GLES20.GL_TRIANGLE_FAN).setId("cubeV1").setFaces(new WavefrontLoader
						.Faces(3));
	}

	public static Object3DData buildNew() {
		return new Object3DData(
				createNativeByteBuffer(cubePositionData2.length * 4).asFloatBuffer().put
						(cubePositionData2))
				.setDrawMode(GLES20.GL_TRIANGLE_STRIP).setId("cubeV1").setFaces(new WavefrontLoader
						.Faces(1));
	}
	...
	public static Object3DData buildCubeV1_with_normals() {
		return new Object3DData(
				...
				.setDrawMode(GLES20.GL_TRIANGLES).setId("cubeV1_light").setFaces(new WavefrontLoader.Faces(8));
	}
	...
	public static Object3DData buildSquareV2Left() {
		IntBuffer drawBuffer = createNativeByteBuffer(squareDrawOrderDataLeft.length * 4)
				.asIntBuffer().put(squareDrawOrderDataLeft);
		FloatBuffer vertexBuffer = createNativeByteBuffer(squarePositionDataLeft2.length * 4)
				.asFloatBuffer().put(squarePositionDataLeft2);
		return new Object3DData(vertexBuffer,drawBuffer.asReadOnlyBuffer()).setDrawMode(GLES20.GL_TRIANGLES).setId("cubeV2")
				.centerAndScale(1.0f).setFaces(new WavefrontLoader.Faces(8)).setDrawOrder(drawBuffer).setVertexArrayBuffer(vertexBuffer);
	}
...
class BoundingBox {
	 ...
	 */
	public BoundingBox(com.example.framgiaphamducnam.demo3dmodelview.entities.BoundingBox box, float[] color) {
		// initialize vertex byte buffer for shape coordinates
	...
	private void calculateVertex(com.example.framgiaphamducnam.demo3dmodelview.entities.BoundingBox box) {
		//@formatter:off
