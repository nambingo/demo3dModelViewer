...
import com.example.framgiaphamducnam.demo3dmodelview.entities.Camera;
import com.example.framgiaphamducnam.demo3dmodelview.model.Object3D;
...
import com.example.framgiaphamducnam.demo3dmodelview.model.Object3DImpl;
import com.example.framgiaphamducnam.demo3dmodelview.services.SceneLoader;
import com.example.framgiaphamducnam.demo3dmodelview.util.GLUtil;
...
//							wireframe.centerAndScale(5.0f);
	...
	public void resetAll(){
		...
		//Matrix.setLookAtM(modelViewMatrix, 0, 0, 0, 6, 0, 0, -1, 0, 1, 0);
		//camera.pointViewToOrigin();
	}
}